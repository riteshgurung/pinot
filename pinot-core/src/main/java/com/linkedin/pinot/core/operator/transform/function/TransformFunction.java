...
public interface TransformFunction {
   ...
   *
   * @param expression The expression associated with the transform function
   * @param dataSourceMap Map from column to data source
   */
  void init(@Nonnull TransformExpressionTree expression, @Nonnull Map<String, DataSource> dataSourceMap);
